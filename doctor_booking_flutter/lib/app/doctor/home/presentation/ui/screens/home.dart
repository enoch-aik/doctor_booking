  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Padding(
          ...
          child: ref.watch(doctorScheduleStreamProvider(currentUser.email!)).when(
              data: (data) {
              ...
              loading: () => const Center(
                    child: CircularProgressIndicator(),
                      ...
                      scheduleViewBuilder: scheduleViewBuilder, sources: []))*/

          //ref.watch(doctorScheduleStreamProvider('email'))
